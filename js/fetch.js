    ...
    <div class="margin-content">
      <div class="box">
        ...
        <div class="links">
          ...
          ></a>
          <a href="uwu" class="grey-link"
            ><i class="fa-brands fa-apple"></i
          ></a>
          <a href="https://github.com/boyratata" class="grey-link"
            ><i class="fa-brands fa-github"></i
          ></a>
          <a href="https://twitter.com/KaraokeYuki" class="grey-link"
            ><i class="fa-brands fa-twitter"></i
          ></a>
          <a href="your_gay" class="grey-link"
            ><i class="fa-brands fa-instagram"></i
          ></a>
          <a href="noballs" class="grey-link"
